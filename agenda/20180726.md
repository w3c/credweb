...
For each project area (inspection, corroboration, reputation, transparency), produce:
* an improvement in current report or specification (eg from blank page to outline, or from draft to improved draft)
* a list of open issues / tasks for moving forward
* some documented discussion of some of those issues
* a list of relevant stakeholders and/or related projects
* a list attendees interested in working on it
...
12:30pm | _Lunch_
2:00pm | Area-1 Issue Discussion
3:30pm | _Break_
4:00pm | Area-2 Issue Discussion
